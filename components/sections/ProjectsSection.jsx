...
export default function ProjectsSection() {
  ...
  return (
    <div
      ...
      style={{
        '--wrapper-height': isMobile ? '100svh' : `${PROJECTS.length * 100}svh`,
        height: isMobile ? '100svh' : `${PROJECTS.length * 100}vh`,
      }}
    >
        ...
        {isMobile && (
          ...
          >
            ...
            <motion.h2 variants={fadeUpVariants} className={styles.mobileHeading}>
              Selected Creative<br />&amp; Dev Portfolios
            </motion.h2>
            ...
            <div className={styles.mobileCardsStack}>
              {PROJECTS.map((proj, i) => (
                ...
                >
                  ...
                  <h3 className={styles.mobileCardTitle}>{proj.title}</h3>
                  <p className={styles.mobileCardDesc}>{proj.desc}</p>
            ...
            <motion.div
              ...
              onClick={() => {
                window.dispatchEvent(new CustomEvent('go-to-section', { detail: 4 }))
              }}
            >
              <span className={styles.mobileScrollText}>Swipe up to view experience</span>
